...
describe('API Client', () => {
  ...
  describe('Menu Items', () => {
    ...
    it('should handle menu items fetch error', async () => {
      // Setup
      (api.getMenuItems as jest.Mock).mockRejectedValueOnce(new Error('Failed to fetch menu items'));
  ...
  describe('Members', () => {
    ...
    it('should handle member not found', async () => {
      // Setup
      (api.getMemberByPhone as jest.Mock).mockRejectedValueOnce(new Error('Failed to fetch member'));
