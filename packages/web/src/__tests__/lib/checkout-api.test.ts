...
describe('Checkout API', () => {
  ...
  describe('placeOrder', () => {
    const mockOrderData = {
      ...
      items: [
        { id: '1', name: 'Latte', price: 4.5, quantity: 2 },
        { id: '2', name: 'Croissant', price: 2.5, quantity: 1 },
      ],
      order_type: 'takeout',
      notes: 'Extra hot',
      ...
      expect(global.fetch).toHaveBeenCalledWith(
        ...
        expect.objectContaining({
          ...
          body: JSON.stringify({
            ...
            orderItems: [
              { menu_item_id: 1, quantity: 2, price_at_time: 4.5 },
              { menu_item_id: 2, quantity: 1, price_at_time: 2.5 },
            ],
          }),
        })
      );
    ...
    it('should calculate total amount correctly', async () => {
      ...
      const orderWithMultipleItems = {
        ...mockOrderData,
        items: [
          { id: '1', name: 'Latte', price: 4.5, quantity: 3 },
          { id: '2', name: 'Croissant', price: 2.5, quantity: 2 },
          { id: '3', name: 'Americano', price: 3.0, quantity: 1 },
        ],
      };
    ...
    it('should use default values for optional fields', async () => {
      ...
      const minimalOrderData = {
        ...
        items: [{ id: '1', name: 'Coffee', price: 3.0, quantity: 1 }],
      };
