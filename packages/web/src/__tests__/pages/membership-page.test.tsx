...
const mockOrders = [
  {
    ...
    items: [
      { menuItemId: '1', quantity: 2, price: 25, name: 'Americano' }
    ]
  },
  {
    id: 'order_2',
    ...
    items: [
      { menuItemId: '2', quantity: 1, price: 35, name: 'Latte' }
    ]
  }
]
...
describe('MembershipPage', () => {
  ...
  it('should show loading states', async () => {
    const user = userEvent.setup()
    mockApi.getMemberByPhone.mockImplementation(() => new Promise(resolve => setTimeout(resolve, 1000)))
